module Pipe
  class ControlCommand
    # def self.dispatch_trigger(parts : Slice(String)) : CommandResult
    ...
    # end
    #
    # def self.dispatch_info(parts : Slice(String)) : CommandResult
    #   case parts.shift?
    #   when nil
    ...
    #     ))])
    #   else
    #     Err(PipeCommandError::InvalidFormat.new("INFO"))
    #   end
    # end
    #
