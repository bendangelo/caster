...
Spectator.describe Lexer::Token do
  ...
  describe ".parse_text" do
    ...
    provided input: "yes where am I hello?"  do
      expect(extract).to eq ["ye", 2685785831, 0, "hello", 4211111929, 4]
    end

    provided input: "re-move these's: 's & + ! @ # $ % ^ & * ( ) \\ | [ ] { } / ? ~ ` = - _ , . 🎄 £ tommy'humanity fff' 'fff don't" do
      expect(extract).to eq ["re", 1398693813, 0, "move", 842472637, 1, "tommi", 2078988828, 5, "human", 3606118738, 6, "fff", 634594538, 7]
    end

    provided input: "5AM IN ＴＯＫＹＯ - Mellow chill ' jazz hip hop beats" do
    ...
    provided input: "a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a a tom hello" do
      expect(extract).to eq ["tom", 4286168139, 245, "hello", 4211111929, 245]
    end
